...
public class OrderService {
    ...
    public long placeOrder(int userId, List<CartLine> lines, String statutInitial) throws SQLException {
    ...
    public List<CommandeRecord> listForUser(int userId) throws SQLException {
    ...
    public OrderStatsSummary statsForUser(int userId) throws SQLException {
