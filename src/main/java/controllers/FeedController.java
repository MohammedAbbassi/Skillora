...
public class FeedController {
    ...
    public void initialize() {
        cbUsers.setItems(FXCollections.observableArrayList(DEMO_USERS));
        cbUsers.setConverter(new StringConverter<User>() {
            @Override public String toString(User u) {
                return u == null ? "" : u.getNomUtilisateur() + "  (" + u.getRole() + ")";
            }
    ...
    private void applySelectedUser(User user) {
        ...
        switch (user.getRole()) {
            ...
            case ENSEIGNANT: roleLabel = "ENSEIGNANT"; roleStyle += "-fx-background-color:#f39c12;"; break;
    ...
    void handlePublish(ActionEvent e) {
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ AI Moderation check Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    void handleChooseImage(ActionEvent e) {
        ...
        if (file != null) {
            // Ã¢â€â‚¬Ã¢â€â‚¬ Image moderation check (Sightengine API) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
            ImageModerationService.ImageModerationResult imgMod =
                ImageModerationService.checkImage(file, session.getCurrentUserId());

            if (!imgMod.safe) {
                // Block the upload and show alert Ã¢â‚¬â€ do NOT set selectedImagePath
                showImageModerationAlert(imgMod);
                return;
            }

            // Image is safe Ã¢â‚¬â€ accept it
    ...
    private VBox buildPostCard(Poste post) {
        ...
        // â”€â”€ Translate button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ COMMENT SECTION Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    private HBox buildCommentInputRow(int postId, Integer parentId, VBox section) {
        ...
        Runnable send = () -> {
            ...
            if (!txt.isEmpty()) {
                // Ã¢â€â‚¬Ã¢â€â‚¬ AI Moderation check Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
                ModerationService.ModerationResult mod =
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ COMMENT ROW Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    private VBox buildCommentRow(Commentaire c, VBox section, boolean isReply) {
        ...
        // Translate button â€” always visible on every comment
    ...
    private void startEditComment(Commentaire c, HBox row, VBox section, VBox wrapper, boolean isReply) {
        ...
        String authorName = resolveUserName(c.getIdUtilisateur());
        Role   authorRole = resolveUserRole(c.getIdUtilisateur());
        Label nameClone = new Label(authorName + "  (" + (authorRole!=null?authorRole:"?") + ")");
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ HELPERS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    private String resolveUserName(int userId) {
        return DEMO_USERS.stream().filter(u -> u.getIdUtilisateur()==userId)
            .map(User::getNomUtilisateur).findFirst().orElse("Utilisateur #"+userId);
    }
    private Role resolveUserRole(int userId) {
        return DEMO_USERS.stream().filter(u -> u.getIdUtilisateur()==userId)
            .map(User::getRole).findFirst().orElse(null);
    }
    private String roleColor(Role role) {
        if (role==null) return "#95a5a6";
        switch(role) { case ADMIN: return "#e74c3c"; case ENSEIGNANT: return "#f39c12"; default: return "#27ae60"; }
    }
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Moderation alert Ã¢â‚¬â€ styled to match the existing UI Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    public void showAdminModerationStats() {
        ...
        info.setHeaderText("Tableau de bord Ã¢â‚¬â€ Moderation IA");
        info.setContentText(
    ...
    public void showAdminImageModerationStats() {
        ...
        Alert info = new Alert(Alert.AlertType.INFORMATION);
        info.setTitle("Statistiques â€” Moderation Images");
        info.setHeaderText("Tableau de bord â€” Images bloquees");
        info.setContentText(
    ...
    // Image moderation alert â€” styled to match existing Skillora UI
    ...
    /**
     * Toggles translation panel below a comment's text box.
     */
    private void toggleCommentTranslation(Commentaire c, VBox textBox, Button btnTranslate) {
        final String TAG = "translation-panel-comment-" + c.getIdCommentaire();
        ...
        VBox panel = buildTranslationPanel(c.getContenu(), btnTranslate, TAG);
        textBox.getChildren().add(panel);
        btnTranslate.setText("Masquer traduction");
    }

    // ══════════════════════════════════════════════════════════
    //  SHARED TRANSLATION PANEL BUILDER
    // ══════════════════════════════════════════════════════════

    /**
     * Builds a compact translation panel:
     *  [AR] [FR] [EN]  ← language buttons
     *  translated text label (appears after selection)
     */
    private VBox buildTranslationPanel(String originalText, Button btnToggle, String tag) {
        VBox panel = new VBox(6);
        panel.setUserData(tag);
        panel.setPadding(new Insets(8, 0, 4, 0));
        panel.setStyle("-fx-background-color:#f0f2f5;-fx-background-radius:8;-fx-padding:8;");

        // Language selector row
        HBox langRow = new HBox(6);
        langRow.setAlignment(Pos.CENTER_LEFT);

        Label lblPick = new Label("Traduire en :");
        lblPick.setStyle("-fx-font-size:12px;-fx-text-fill:#65676b;-fx-font-weight:bold;");

        // Translated text label (hidden until a language is chosen)
        Label lblTranslated = new Label();
        lblTranslated.setWrapText(true);
        lblTranslated.setStyle(
            "-fx-font-size:13px;-fx-text-fill:#050505;"
        ...
        lblTranslated.setManaged(false);

        // Loading indicator
        Label lblLoading = new Label("Traduction en cours...");
        lblLoading.setStyle("-fx-font-size:12px;-fx-text-fill:#1877f2;-fx-font-style:italic;");
        lblLoading.setVisible(false);
        lblLoading.setManaged(false);

        // Language buttons: AR / FR / EN
        for (String[] lang : new String[][]{{"AR", "ar"}, {"FR", "fr"}, {"EN", "en"}}) {
            Button btn = new Button(lang[0]);
            btn.setStyle(
                "-fx-background-color:#1877f2;-fx-text-fill:white;"
                + "-fx-font-weight:bold;-fx-font-size:11px;"
                + "-fx-background-radius:14;-fx-padding:3 10;"
                + "-fx-cursor:hand;-fx-border-color:transparent;"
            );
            final String targetCode = lang[1];
            btn.setOnAction(ev -> {
                // Show loading
                ...
                // Run translation on background thread to avoid freezing UI
                new Thread(() -> {
                    String translated = TranslationService.translateText(
                        originalText, TranslationService.LANG_AUTO, targetCode);
                    ...
                    javafx.application.Platform.runLater(() -> {
                        ...
                        lblTranslated.setVisible(true);
                        lblTranslated.setManaged(true);
                    });
                }, "translation-thread").start();
            });
            langRow.getChildren().add(btn);
        }

        langRow.getChildren().add(0, lblPick);
        panel.getChildren().addAll(langRow, lblLoading, lblTranslated);
        return panel;
    }

    // ── Repost handler ─────────────────────────────────────────
    private void handleRepost(Poste post) {
        try {
            Poste repost = posteService.repost(post.getIdPost(), session.getCurrentUserId());
            if (repost == null) {
                showToast("Vous avez deja repartage ce post.");
            } else {
                showToast("Post repartage avec succes !");
                loadFeed();
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    // ── Badge color helper ─────────────────────────────────────
    private String badgeColor(entities.Badge badge) {        if (badge == null) return "#95a5a6";
        switch (badge) {
            case PRO:     return "#e74c3c";  // red
            case ACTIF:   return "#1877f2";  // blue
            default:      return "#27ae60";  // green (DEBUTANT)
        }
    }
}
